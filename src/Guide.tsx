...
const step3svg = (
  <svg viewBox="0 0 360 100" className="w-full">
    <text x={50} y={10} textAnchor="middle" fontSize={9} fontWeight="bold" fill="#cdd6f4">Open A</text>
    ...
    <text x={20} y={13} textAnchor="middle" fontSize={7} fill="#7f849c">×</text>
    ...
    <text x={108} y={48} fontSize={16} fill="#89b4fa">→</text>
    <text x={108} y={62} textAnchor="middle" fontSize={7} fill="#7f849c">barre@3</text>

    <text x={180} y={10} textAnchor="middle" fontSize={9} fontWeight="bold" fill="#cdd6f4">C (A@3)</text>
    <rect x={145} y={16} width={70} height={60} rx={3} fill="#1a1408" />
    <text x={143} y={30} textAnchor="end" fontSize={7} fill="#7f849c">3</text>
    ...
    <text x={145} y={13} textAnchor="middle" fontSize={7} fill="#7f849c">×</text>
    ...
    <text x={238} y={48} fontSize={16} fill="#89b4fa">=</text>

    <text x={300} y={10} textAnchor="middle" fontSize={9} fontWeight="bold" fill="#cdd6f4">Shape Grid</text>
    ...
    <text x={252} y={36} textAnchor="end" fontSize={7} fill="#7f849c">A</text>
    <text x={252} y={54} textAnchor="end" fontSize={7} fill="#7f849c">E</text>
    <line x1={300} y1={18} x2={300} y2={62} stroke="#2a3a5a" strokeWidth={0.8} />
    <text x={300} y={75} textAnchor="middle" fontSize={7} fill="#7f849c">3</text>
    <circle cx={300} cy={32} r={8} fill="#f38ba8" />
    <text x={300} y={35} textAnchor="middle" fontSize={7} fill="#fff" fontWeight="bold">1</text>
    <text x={300} y={90} textAnchor="middle" fontSize={7} fill="#89b4fa">↑ C here</text>
  </svg>
);
  ...
  return (
    <>
      <button onClick={toggle}
        ...
        style={{ transition: 'all var(--transition)' }} title="Help"
      >?</button>

      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-crust/90 backdrop-blur-sm"
          style={{ animation: 'fadeIn 0.25s ease' }} onClick={toggle}>
